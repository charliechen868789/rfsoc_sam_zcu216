...
proc create_hier_cell_transmitter { parentCell nameHier } {
  ...
  connect_bd_net -net proc_sys_reset_clk_dac0_peripheral_aresetn [get_bd_pins M00_ARESETN] [get_bd_pins channel_00/AXI4_Lite_ARESETN] [get_bd_pins axi_interconnect/M00_ARESETN]
  connect_bd_net -net proc_sys_reset_clk_dac2_peripheral_aresetn [get_bd_pins M01_ARESETN] [get_bd_pins channel_20/AXI4_Lite_ARESETN] [get_bd_pins axi_interconnect/M01_ARESETN]
  connect_bd_net -net usp_rf_data_converter_clk_dac0 [get_bd_pins M00_ACLK] [get_bd_pins channel_00/AXI4_Lite_ACLK] [get_bd_pins axi_interconnect/M00_ACLK]
  connect_bd_net -net usp_rf_data_converter_clk_dac2 [get_bd_pins M01_ACLK] [get_bd_pins channel_20/AXI4_Lite_ACLK] [get_bd_pins axi_interconnect/M01_ACLK]
...
proc create_hier_cell_receiver { parentCell nameHier } {
  ...
  connect_bd_net -net proc_sys_reset_clk_adc2_peripheral_aresetn [get_bd_pins S02_ARESETN] [get_bd_pins channel_20/AXI4_Lite_ARESETN] [get_bd_pins channel_22/AXI4_Lite_ARESETN] [get_bd_pins axi_interconnect/M04_ARESETN] [get_bd_pins axi_interconnect/M05_ARESETN] [get_bd_pins axi_interconnect/M06_ARESETN] [get_bd_pins axi_interconnect/M07_ARESETN] [get_bd_pins axi_interconnect_sam/S02_ARESETN] [get_bd_pins axi_interconnect_sam/S03_ARESETN]
  ...
  connect_bd_net -net usp_rf_data_converter_clk_adc2 [get_bd_pins S02_ACLK] [get_bd_pins channel_20/clk] [get_bd_pins channel_22/clk] [get_bd_pins axi_interconnect/M04_ACLK] [get_bd_pins axi_interconnect/M05_ACLK] [get_bd_pins axi_interconnect/M06_ACLK] [get_bd_pins axi_interconnect/M07_ACLK] [get_bd_pins axi_interconnect_sam/S02_ACLK] [get_bd_pins axi_interconnect_sam/S03_ACLK]
...
proc create_hier_cell_radio { parentCell nameHier } {
  ...
  connect_bd_net -net proc_sys_reset_clk_dac0_peripheral_aresetn [get_bd_pins proc_sys_reset_clk_dac0/peripheral_aresetn] [get_bd_pins transmitter/M00_ARESETN] [get_bd_pins rfdc/s0_axis_aresetn]
  connect_bd_net -net proc_sys_reset_clk_dac2_peripheral_aresetn [get_bd_pins proc_sys_reset_clk_dac2/peripheral_aresetn] [get_bd_pins transmitter/M01_ARESETN] [get_bd_pins rfdc/s2_axis_aresetn]
  ...
  connect_bd_net -net usp_rf_data_converter_clk_adc2 [get_bd_pins rfdc/clk_adc2] [get_bd_pins receiver/S02_ACLK] [get_bd_pins proc_sys_reset_clk_adc2/slowest_sync_clk] [get_bd_pins rfdc/m2_axis_aclk]
  connect_bd_net -net usp_rf_data_converter_clk_dac0 [get_bd_pins rfdc/clk_dac0] [get_bd_pins transmitter/M00_ACLK] [get_bd_pins proc_sys_reset_clk_dac0/slowest_sync_clk] [get_bd_pins rfdc/s0_axis_aclk]
  connect_bd_net -net usp_rf_data_converter_clk_dac2 [get_bd_pins rfdc/clk_dac2] [get_bd_pins transmitter/M01_ACLK] [get_bd_pins proc_sys_reset_clk_dac2/slowest_sync_clk] [get_bd_pins rfdc/s2_axis_aclk]
...
\
  ...
  assign_bd_address -offset 0xA0080000 -range 0x00010000 -with_name SEG_control_reg0_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/transmitter/channel_00/control/AXI4_Lite/reg0] -force
  ...
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -with_name SEG_decimator_reg0_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_22/decimator/xsg_bwselector_s_axi/reg0] -force
  ...
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -with_name SEG_spectrum_analyser_reg0_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_20/spectrum_analyser/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA0070000 -range 0x00010000 -with_name SEG_spectrum_analyser_reg0_2 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_22/spectrum_analyser/AXI4_Lite/reg0] -force
  ...
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces radio/receiver/channel_20/spectrum_analyser/AXI4_Master] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_HIGH]
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces radio/receiver/channel_22/spectrum_analyser/AXI4_Master] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_HIGH]
