...
proc create_hier_cell_transmitter { parentCell nameHier } {
  ...
  connect_bd_net -net M00_ACLK_1 [get_bd_pins m00_axis_aclk] [get_bd_pins channel_00/s_axi_aclk] [get_bd_pins axi_interconnect_ps/M00_ACLK]
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins m00_axis_aresetn] [get_bd_pins channel_00/s_axi_aresetn] [get_bd_pins axi_interconnect_ps/M00_ARESETN]
  connect_bd_net -net rst_usp_rf_data_converter_256M_peripheral_aresetn [get_bd_pins m10_axis_aresetn] [get_bd_pins channel_10/s_axi_aresetn] [get_bd_pins axi_interconnect_ps/M01_ARESETN]
  connect_bd_net -net usp_rf_data_converter_clk_dac1 [get_bd_pins m10_axis_aclk] [get_bd_pins channel_10/s_axi_aclk] [get_bd_pins axi_interconnect_ps/M01_ACLK]
...
proc create_hier_cell_receiver { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net ACLK_1 [get_bd_pins s_axi_aclk] [get_bd_pins channel_00/s_axi_aclk] [get_bd_pins channel_20/s_axi_aclk] [get_bd_pins m_axi_interconnect/ACLK] [get_bd_pins m_axi_interconnect/S00_ACLK] [get_bd_pins m_axi_interconnect/M00_ACLK] [get_bd_pins m_axi_interconnect/M01_ACLK]
  connect_bd_net -net ARESETN_1 [get_bd_pins s_axi_aresetn] [get_bd_pins channel_00/s_axi_aresetn] [get_bd_pins channel_20/s_axi_aresetn] [get_bd_pins m_axi_interconnect/ARESETN] [get_bd_pins m_axi_interconnect/S00_ARESETN] [get_bd_pins m_axi_interconnect/M00_ARESETN] [get_bd_pins m_axi_interconnect/M01_ARESETN]
...
proc create_hier_cell_radio { parentCell nameHier } {
  ...
  connect_bd_net -net proc_sys_reset_dac0_peripheral_aresetn [get_bd_pins proc_sys_reset_dac0/peripheral_aresetn] [get_bd_pins transmitter/m00_axis_aresetn] [get_bd_pins rfdc/s0_axis_aresetn]
  ...
  connect_bd_net -net rfdc_clk_adc0 [get_bd_pins rfdc/clk_adc0] [get_bd_pins receiver/s00_axis_aclk] [get_bd_pins proc_sys_reset_adc0/slowest_sync_clk] [get_bd_pins rfdc/m0_axis_aclk]
  connect_bd_net -net rfdc_clk_dac0 [get_bd_pins rfdc/clk_dac0] [get_bd_pins transmitter/m00_axis_aclk] [get_bd_pins proc_sys_reset_dac0/slowest_sync_clk] [get_bd_pins rfdc/s0_axis_aclk]
  ...
  connect_bd_net -net rst_usp_rf_data_converter_256M_peripheral_aresetn [get_bd_pins proc_sys_reset_dac1/peripheral_aresetn] [get_bd_pins transmitter/m10_axis_aresetn] [get_bd_pins rfdc/s1_axis_aresetn]
  connect_bd_net -net usp_rf_data_converter_clk_adc2 [get_bd_pins rfdc/clk_adc2] [get_bd_pins receiver/s20_axis_aclk] [get_bd_pins proc_sys_reset_adc2/slowest_sync_clk] [get_bd_pins rfdc/m2_axis_aclk]
  connect_bd_net -net usp_rf_data_converter_clk_dac1 [get_bd_pins rfdc/clk_dac1] [get_bd_pins transmitter/m10_axis_aclk] [get_bd_pins proc_sys_reset_dac1/slowest_sync_clk] [get_bd_pins rfdc/s1_axis_aclk]
...
\
  ...
  connect_bd_net -net zynq_ultra_ps_e_pl_clk0 [get_bd_pins zynq_ultra_ps_e/pl_clk0] [get_bd_pins radio/s_axi_aclk] [get_bd_pins rst_ps8_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e/maxihpm0_lpd_aclk]
  ...
  assign_bd_address -offset 0x80080000 -range 0x00010000 -with_name SEG_control_reg0_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/transmitter/channel_10/control/AXI4_Lite/reg0] -force
  ...
  assign_bd_address -offset 0x80070000 -range 0x00010000 -with_name SEG_decimator_reg0_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_20/decimator/xsg_bwselector_s_axi/reg0] -force
  ...
  assign_bd_address -offset 0x80060000 -range 0x00010000 -with_name SEG_spectrum_analyser_reg0_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_20/spectrum_analyser/AXI4_Lite/reg0] -force
