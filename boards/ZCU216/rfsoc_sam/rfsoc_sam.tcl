...
# Hierarchical cell: channel_32
proc create_hier_cell_channel_32 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_channel_32() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins axis_broadcaster/M00_AXIS] [get_bd_intf_pins axis_combiner/S00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins axis_broadcaster/M01_AXIS] [get_bd_intf_pins axis_combiner/S01_AXIS]
  ...
  connect_bd_net -net proc_sys_reset_clk_dac0_peripheral_aresetn [get_bd_pins AXI4_Lite_ARESETN] [get_bd_pins control/AXI4_Lite_ARESETN] [get_bd_pins control/IPCORE_RESETN] [get_bd_pins axis_broadcaster/aresetn] [get_bd_pins axis_combiner/aresetn]
  connect_bd_net -net usp_rf_data_converter_clk_dac0 [get_bd_pins AXI4_Lite_ACLK] [get_bd_pins control/AXI4_Lite_ACLK] [get_bd_pins control/IPCORE_CLK] [get_bd_pins axis_broadcaster/aclk] [get_bd_pins axis_combiner/aclk]
...
proc create_hier_cell_channel_22 { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_interconnect_M00_AXI [get_bd_intf_pins AXI4_Lite] [get_bd_intf_pins control/AXI4_Lite]
  connect_bd_intf_net -intf_net axis_broadcaster1_M00_AXIS [get_bd_intf_pins axis_broadcaster/M00_AXIS] [get_bd_intf_pins axis_combiner/S00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster1_M01_AXIS [get_bd_intf_pins axis_broadcaster/M01_AXIS] [get_bd_intf_pins axis_combiner/S01_AXIS]
  connect_bd_intf_net -intf_net axis_combiner_M_AXIS [get_bd_intf_pins AXI4_Stream_Master] [get_bd_intf_pins axis_combiner/M_AXIS]
  connect_bd_intf_net -intf_net control_AXI4_Stream_Master [get_bd_intf_pins axis_broadcaster/S_AXIS] [get_bd_intf_pins control/AXI4_Stream_Master]
...
proc create_hier_cell_transmitter { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 AXI4_Stream_Master2

  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 AXI4_Stream_Master3
  ...
  # Create instance: channel_32
  create_hier_cell_channel_32 $hier_obj channel_32

  # Create interface connections
  connect_bd_intf_net -intf_net AXI4_Lite_1 [get_bd_intf_pins axi_interconnect/M01_AXI] [get_bd_intf_pins channel_22/AXI4_Lite]
  connect_bd_intf_net -intf_net AXI4_Lite_2 [get_bd_intf_pins axi_interconnect/M03_AXI] [get_bd_intf_pins channel_32/AXI4_Lite]
  connect_bd_intf_net -intf_net AXI4_Lite_3 [get_bd_intf_pins axi_interconnect/M02_AXI] [get_bd_intf_pins channel_30/AXI4_Lite]
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins AXI4_Stream_Master2] [get_bd_intf_pins channel_30/AXI4_Stream_Master]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins AXI4_Stream_Master3] [get_bd_intf_pins channel_32/AXI4_Stream_Master]
  connect_bd_intf_net -intf_net axi_interconnect_M00_AXI [get_bd_intf_pins axi_interconnect/M00_AXI] [get_bd_intf_pins channel_20/AXI4_Lite]
  ...
  connect_bd_intf_net -intf_net channel_20_AXI4_Stream_Master [get_bd_intf_pins AXI4_Stream_Master] [get_bd_intf_pins channel_22/AXI4_Stream_Master]
  connect_bd_intf_net -intf_net control_AXI4_Stream_Master [get_bd_intf_pins AXI4_Stream_Master1] [get_bd_intf_pins channel_20/AXI4_Stream_Master]
  ...
  connect_bd_net -net M01_ACLK_1 [get_bd_pins M01_ACLK] [get_bd_pins channel_30/AXI4_Lite_ACLK] [get_bd_pins channel_32/AXI4_Lite_ACLK] [get_bd_pins axi_interconnect/M02_ACLK] [get_bd_pins axi_interconnect/M03_ACLK]
  connect_bd_net -net M01_ARESETN_1 [get_bd_pins M01_ARESETN] [get_bd_pins channel_30/AXI4_Lite_ARESETN] [get_bd_pins channel_32/AXI4_Lite_ARESETN] [get_bd_pins axi_interconnect/M02_ARESETN] [get_bd_pins axi_interconnect/M03_ARESETN]
  ...
  connect_bd_net -net proc_sys_reset_clk_dac0_peripheral_aresetn [get_bd_pins M00_ARESETN] [get_bd_pins channel_20/AXI4_Lite_ARESETN] [get_bd_pins channel_22/AXI4_Lite_ARESETN] [get_bd_pins axi_interconnect/M00_ARESETN] [get_bd_pins axi_interconnect/M01_ARESETN]
  connect_bd_net -net usp_rf_data_converter_clk_dac0 [get_bd_pins M00_ACLK] [get_bd_pins channel_20/AXI4_Lite_ACLK] [get_bd_pins channel_22/AXI4_Lite_ACLK] [get_bd_pins axi_interconnect/M00_ACLK] [get_bd_pins axi_interconnect/M01_ACLK]
...
proc create_hier_cell_receiver { parentCell nameHier } {
  ...
  # Create instance: axi_interconnect, and set properties
  set axi_interconnect [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_interconnect ]
  set_property CONFIG.NUM_MI {8} $axi_interconnect
  ...
  connect_bd_intf_net -intf_net AXI4_Lite_2 [get_bd_intf_pins axi_interconnect/M04_AXI] [get_bd_intf_pins channel_10/AXI4_Lite]
  connect_bd_intf_net -intf_net AXI4_Lite_3 [get_bd_intf_pins axi_interconnect/M06_AXI] [get_bd_intf_pins channel_12/AXI4_Lite]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_hpm0_M05_AXI [get_bd_intf_pins axi_interconnect/M05_AXI] [get_bd_intf_pins channel_10/xsg_bwselector_s_axi]
  connect_bd_intf_net -intf_net axi_interconnect_hpm0_M07_AXI [get_bd_intf_pins axi_interconnect/M07_AXI] [get_bd_intf_pins channel_12/xsg_bwselector_s_axi]
  ...
  connect_bd_intf_net -intf_net channel_20_AXI4_Master [get_bd_intf_pins axi_interconnect_sam/S02_AXI] [get_bd_intf_pins channel_10/AXI4_Master]
  connect_bd_intf_net -intf_net channel_22_AXI4_Master [get_bd_intf_pins axi_interconnect_sam/S03_AXI] [get_bd_intf_pins channel_12/AXI4_Master]
  connect_bd_intf_net -intf_net s_axis_im_1 [get_bd_intf_pins s_axis_im] [get_bd_intf_pins channel_02/s_axis_im]
  connect_bd_intf_net -intf_net s_axis_im_2 [get_bd_intf_pins s_axis_im1] [get_bd_intf_pins channel_10/s_axis_im]
  connect_bd_intf_net -intf_net s_axis_im_3 [get_bd_intf_pins s_axis_im2] [get_bd_intf_pins channel_12/s_axis_im]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_m20_axis [get_bd_intf_pins s_axis_re1] [get_bd_intf_pins channel_10/s_axis_re]
  connect_bd_intf_net -intf_net usp_rf_data_converter_m22_axis [get_bd_intf_pins s_axis_re2] [get_bd_intf_pins channel_12/s_axis_re]
  ...
  connect_bd_net -net proc_sys_reset_clk_adc0_peripheral_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins channel_00/AXI4_Lite_ARESETN] [get_bd_pins channel_02/AXI4_Lite_ARESETN] [get_bd_pins axi_interconnect/M00_ARESETN] [get_bd_pins axi_interconnect/M01_ARESETN] [get_bd_pins axi_interconnect/M02_ARESETN] [get_bd_pins axi_interconnect/M03_ARESETN] [get_bd_pins axi_interconnect_sam/S00_ARESETN] [get_bd_pins axi_interconnect_sam/S01_ARESETN]
  connect_bd_net -net proc_sys_reset_clk_adc2_peripheral_aresetn [get_bd_pins S02_ARESETN] [get_bd_pins channel_10/AXI4_Lite_ARESETN] [get_bd_pins channel_12/AXI4_Lite_ARESETN] [get_bd_pins axi_interconnect/M04_ARESETN] [get_bd_pins axi_interconnect/M05_ARESETN] [get_bd_pins axi_interconnect/M06_ARESETN] [get_bd_pins axi_interconnect/M07_ARESETN] [get_bd_pins axi_interconnect_sam/S02_ARESETN] [get_bd_pins axi_interconnect_sam/S03_ARESETN]
  connect_bd_net -net usp_rf_data_converter_clk_adc0 [get_bd_pins S00_ACLK] [get_bd_pins channel_00/clk] [get_bd_pins channel_02/clk] [get_bd_pins axi_interconnect/M00_ACLK] [get_bd_pins axi_interconnect/M01_ACLK] [get_bd_pins axi_interconnect/M02_ACLK] [get_bd_pins axi_interconnect/M03_ACLK] [get_bd_pins axi_interconnect_sam/S00_ACLK] [get_bd_pins axi_interconnect_sam/S01_ACLK]
  connect_bd_net -net usp_rf_data_converter_clk_adc2 [get_bd_pins S02_ACLK] [get_bd_pins channel_10/clk] [get_bd_pins channel_12/clk] [get_bd_pins axi_interconnect/M04_ACLK] [get_bd_pins axi_interconnect/M05_ACLK] [get_bd_pins axi_interconnect/M06_ACLK] [get_bd_pins axi_interconnect/M07_ACLK] [get_bd_pins axi_interconnect_sam/S02_ACLK] [get_bd_pins axi_interconnect_sam/S03_ACLK]
...
proc create_hier_cell_radio { parentCell nameHier } {
  ...
  # Create instance: proc_sys_reset_clk_adc1, and set properties
  set proc_sys_reset_clk_adc1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_clk_adc1 ]
  ...
  # Create instance: proc_sys_reset_clk_dac3, and set properties
  set proc_sys_reset_clk_dac3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 proc_sys_reset_clk_dac3 ]
  ...
  # settings. The existing decimator IP has a real/imag AXI4-Stream input
  # hard-coded to 128 bits (8 samples/clock) in its generated VHDL (from a
  # System Generator export not available to regenerate here), so it can't
  # be reparameterised for the ZU49DR's 12-sample/clock output directly.
  # The adapter chain after "Create port connections" below (axis_iq_deinterleave
  # + axis_dwidth_converter + axis_clock_converter, one set per channel)
  # bridges this: de-interleave the packed stream, widen 96->128 bits, and
  # clock-convert into the already-present 153.6MHz dac2_clk domain to match
  # the decimator's fixed port. The de-interleaver's assumed bit-packing
  # order (sample 0 at TDATA's LSBs, I above Q within each pair) was not
  # independently confirmed against PG269's primary tables -- verify against
  # real hardware (a known test tone should appear at the expected sign/
  # frequency, not mirrored) and flip axis_iq_deinterleave's SAMPLE0_AT_LSB /
  # I_IN_UPPER_HALF generics if it is not.
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins adc1_clk] [get_bd_intf_pins rfdc/adc1_clk]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins vin10] [get_bd_intf_pins rfdc/vin10]
  connect_bd_intf_net -intf_net Conn3 [get_bd_intf_pins vin12] [get_bd_intf_pins rfdc/vin12]
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins vout22] [get_bd_intf_pins rfdc/vout22]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins vout30] [get_bd_intf_pins rfdc/vout30]
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins vout32] [get_bd_intf_pins rfdc/vout32]
  ...
  connect_bd_intf_net -intf_net transmitter_AXI4_Stream_Master [get_bd_intf_pins rfdc/s22_axis] [get_bd_intf_pins transmitter/AXI4_Stream_Master]
  connect_bd_intf_net -intf_net transmitter_AXI4_Stream_Master1 [get_bd_intf_pins rfdc/s20_axis] [get_bd_intf_pins transmitter/AXI4_Stream_Master1]
  connect_bd_intf_net -intf_net transmitter_AXI4_Stream_Master2 [get_bd_intf_pins rfdc/s30_axis] [get_bd_intf_pins transmitter/AXI4_Stream_Master2]
  connect_bd_intf_net -intf_net transmitter_AXI4_Stream_Master3 [get_bd_intf_pins rfdc/s32_axis] [get_bd_intf_pins transmitter/AXI4_Stream_Master3]
  connect_bd_intf_net -intf_net usp_rf_data_converter_vout20 [get_bd_intf_pins vout20] [get_bd_intf_pins rfdc/vout20]
  connect_bd_intf_net -intf_net vin00_1 [get_bd_intf_pins vin00] [get_bd_intf_pins rfdc/vin00]
  connect_bd_intf_net -intf_net vin02_1 [get_bd_intf_pins vin02] [get_bd_intf_pins rfdc/vin02]

  # Create port connections
  connect_bd_net -net ARESETN_1 [get_bd_pins ARESETN] [get_bd_pins receiver/ARESETN] [get_bd_pins transmitter/ARESETN] [get_bd_pins axi_interconnect_hpm0/ARESETN]
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins S00_ARESETN1] [get_bd_pins receiver/S00_ARESETN1] [get_bd_pins transmitter/S00_ARESETN] [get_bd_pins axi_interconnect_hpm0/S00_ARESETN] [get_bd_pins axi_interconnect_hpm0/M00_ARESETN] [get_bd_pins axi_interconnect_hpm0/M01_ARESETN]
  connect_bd_net -net clk_wiz_307_2M_clk_out1 [get_bd_pins M00_ACLK] [get_bd_pins receiver/M00_ACLK] [get_bd_pins transmitter/S00_ACLK] [get_bd_pins axi_interconnect_hpm0/ACLK] [get_bd_pins axi_interconnect_hpm0/S00_ACLK] [get_bd_pins axi_interconnect_hpm0/M00_ACLK] [get_bd_pins axi_interconnect_hpm0/M01_ACLK]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins rfdc/s_axi_aresetn]
  connect_bd_net -net proc_sys_reset_clk_adc0_peripheral_aresetn [get_bd_pins proc_sys_reset_clk_adc0/peripheral_aresetn] [get_bd_pins rfdc/m0_axis_aresetn]
  connect_bd_net -net proc_sys_reset_clk_adc2_peripheral_aresetn [get_bd_pins proc_sys_reset_clk_adc1/peripheral_aresetn] [get_bd_pins rfdc/m1_axis_aresetn]
  connect_bd_net -net proc_sys_reset_clk_dac0_peripheral_aresetn [get_bd_pins proc_sys_reset_clk_dac2/peripheral_aresetn] [get_bd_pins transmitter/M00_ARESETN] [get_bd_pins rfdc/s2_axis_aresetn] [get_bd_pins receiver/S00_ARESETN] [get_bd_pins receiver/S02_ARESETN]
  connect_bd_net -net proc_sys_reset_clk_dac2_peripheral_aresetn [get_bd_pins proc_sys_reset_clk_dac3/peripheral_aresetn] [get_bd_pins transmitter/M01_ARESETN] [get_bd_pins rfdc/s3_axis_aresetn]
  connect_bd_net -net rfdc_clk_dac3 [get_bd_pins rfdc/clk_dac3] [get_bd_pins transmitter/M01_ACLK] [get_bd_pins proc_sys_reset_clk_dac3/slowest_sync_clk] [get_bd_pins rfdc/s3_axis_aclk]
  connect_bd_net -net usp_rf_data_converter_clk_adc0 [get_bd_pins rfdc/clk_adc0] [get_bd_pins proc_sys_reset_clk_adc0/slowest_sync_clk] [get_bd_pins rfdc/m0_axis_aclk]
  connect_bd_net -net usp_rf_data_converter_clk_adc2 [get_bd_pins rfdc/clk_adc1] [get_bd_pins proc_sys_reset_clk_adc1/slowest_sync_clk] [get_bd_pins rfdc/m1_axis_aclk]
  connect_bd_net -net usp_rf_data_converter_clk_dac0 [get_bd_pins rfdc/clk_dac2] [get_bd_pins transmitter/M00_ACLK] [get_bd_pins proc_sys_reset_clk_dac2/slowest_sync_clk] [get_bd_pins rfdc/s2_axis_aclk] [get_bd_pins receiver/S00_ACLK] [get_bd_pins receiver/S02_ACLK]
  connect_bd_net -net zynq_ultra_ps_e_pl_clk0 [get_bd_pins s_axi_aclk] [get_bd_pins rfdc/s_axi_aclk]
  connect_bd_net -net zynq_ultra_ps_e_pl_resetn0 [get_bd_pins ext_reset_in] [get_bd_pins proc_sys_reset_clk_adc0/ext_reset_in] [get_bd_pins proc_sys_reset_clk_adc1/ext_reset_in] [get_bd_pins proc_sys_reset_clk_dac2/ext_reset_in] [get_bd_pins proc_sys_reset_clk_dac3/ext_reset_in]

  # ZCU216 I/Q adapter chain (see KNOWN ISSUE note above the rfdc cell).
  # Each enabled ADC slice (m00,m02 on clk_adc0; m10,m12 on clk_adc1) carries
  # 6 packed complex samples/clock (192-bit) instead of ZCU208's separate
  # real/imag ports. For each one: de-interleave into two 96-bit real streams,
  # then width-convert 96->128 bit and clock-convert into the dac2_clk domain
  # (153.6MHz, already used by receiver/S00_ACLK and S02_ACLK above) to
  # match the decimator's fixed 128-bit (8 samples/clock) port -- reusing
  # existing clocks/resets rather than adding a new clock wizard.
  foreach {suffix src_axis re_pin im_pin adc_clk adc_rst} {
    003 m00_axis s_axis_re3 s_axis_im3 clk_adc0 proc_sys_reset_clk_adc0
    0   m02_axis s_axis_re  s_axis_im  clk_adc0 proc_sys_reset_clk_adc0
    12  m10_axis s_axis_re1 s_axis_im1 clk_adc1 proc_sys_reset_clk_adc1
    2   m12_axis s_axis_re2 s_axis_im2 clk_adc1 proc_sys_reset_clk_adc1
  } {
    set deint [ create_bd_cell -type module -reference axis_iq_deinterleave iq_deint_${suffix} ]
    set_property -dict [list CONFIG.SAMPLES {6} CONFIG.SAMPLE_BITS {16}] $deint

    connect_bd_intf_net [get_bd_intf_pins rfdc/${src_axis}] [get_bd_intf_pins ${deint}/s_axis]
    connect_bd_net [get_bd_pins rfdc/${adc_clk}] [get_bd_pins ${deint}/aclk]
    connect_bd_net [get_bd_pins ${adc_rst}/peripheral_aresetn] [get_bd_pins ${deint}/aresetn]

    foreach {half target_pin} [list re $re_pin im $im_pin] {
      set dwc [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 dwc_${suffix}_${half} ]
      set_property -dict [list CONFIG.S_TDATA_NUM_BYTES {12} CONFIG.M_TDATA_NUM_BYTES {16}] $dwc
      connect_bd_intf_net [get_bd_intf_pins ${deint}/m_axis_${half}] [get_bd_intf_pins ${dwc}/S_AXIS]
      connect_bd_net [get_bd_pins rfdc/${adc_clk}] [get_bd_pins ${dwc}/aclk]
      connect_bd_net [get_bd_pins ${adc_rst}/peripheral_aresetn] [get_bd_pins ${dwc}/aresetn]

      set cc [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_clock_converter:1.1 cc_${suffix}_${half} ]
      set_property -dict [list CONFIG.TDATA_NUM_BYTES {16}] $cc
      connect_bd_intf_net [get_bd_intf_pins ${dwc}/M_AXIS] [get_bd_intf_pins ${cc}/S_AXIS]
      connect_bd_net [get_bd_pins rfdc/${adc_clk}] [get_bd_pins ${cc}/s_axis_aclk]
      connect_bd_net [get_bd_pins ${adc_rst}/peripheral_aresetn] [get_bd_pins ${cc}/s_axis_aresetn]
      connect_bd_net [get_bd_pins rfdc/clk_dac2] [get_bd_pins ${cc}/m_axis_aclk]
      connect_bd_net [get_bd_pins proc_sys_reset_clk_dac2/peripheral_aresetn] [get_bd_pins ${cc}/m_axis_aresetn]

      connect_bd_intf_net [get_bd_intf_pins ${cc}/M_AXIS] [get_bd_intf_pins receiver/${target_pin}]
    }
  }
...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.NUM_MI {1} $ps8_axi_periph
  ...
  connect_bd_intf_net -intf_net default_sysclk_c0_300mhz_1 [get_bd_intf_ports default_sysclk_c0_300mhz] [get_bd_intf_pins clk_wiz_307_2M/CLK_IN1_D]
  connect_bd_intf_net -intf_net ps8_axi_periph_M00_AXI [get_bd_intf_pins ps8_axi_periph/M00_AXI] [get_bd_intf_pins radio/s_axi]
  connect_bd_intf_net -intf_net radio_vout22 [get_bd_intf_ports vout22] [get_bd_intf_pins radio/vout22]
  connect_bd_intf_net -intf_net radio_vout30 [get_bd_intf_ports vout30] [get_bd_intf_pins radio/vout30]
  connect_bd_intf_net -intf_net radio_vout32 [get_bd_intf_ports vout32] [get_bd_intf_pins radio/vout32]
  ...
  connect_bd_intf_net -intf_net vin00_1 [get_bd_intf_ports vin00] [get_bd_intf_pins radio/vin00]
  connect_bd_intf_net -intf_net vin02_1 [get_bd_intf_ports vin02] [get_bd_intf_pins radio/vin02]
  connect_bd_intf_net -intf_net vin10_1 [get_bd_intf_ports vin10] [get_bd_intf_pins radio/vin10]
  connect_bd_intf_net -intf_net vin12_1 [get_bd_intf_ports vin12] [get_bd_intf_pins radio/vin12]
  ...
  connect_bd_net -net M00_ARESETN_1 [get_bd_pins proc_sys_reset_307_2M/peripheral_aresetn] [get_bd_pins radio/S00_ARESETN1] [get_bd_pins axi_data_fifo1/aresetn] [get_bd_pins axi_data_fifo/aresetn]
  connect_bd_net -net clk_wiz_307_2M_clk_out1 [get_bd_pins clk_wiz_307_2M/clk_out1] [get_bd_pins radio/M00_ACLK] [get_bd_pins axi_data_fifo1/aclk] [get_bd_pins axi_data_fifo/aclk] [get_bd_pins proc_sys_reset_307_2M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e/saxihp2_fpd_aclk]
  connect_bd_net -net clk_wiz_307_2M_locked [get_bd_pins clk_wiz_307_2M/locked] [get_bd_pins proc_sys_reset_307_2M/dcm_locked]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_100M/peripheral_aresetn] [get_bd_pins radio/s_axi_aresetn] [get_bd_pins ps8_axi_periph/ARESETN] [get_bd_pins ps8_axi_periph/S00_ARESETN] [get_bd_pins ps8_axi_periph/M00_ARESETN]
  connect_bd_net -net zynq_ultra_ps_e_pl_clk0 [get_bd_pins zynq_ultra_ps_e/pl_clk0] [get_bd_pins radio/s_axi_aclk] [get_bd_pins proc_sys_reset_100M/slowest_sync_clk] [get_bd_pins ps8_axi_periph/ACLK] [get_bd_pins ps8_axi_periph/S00_ACLK] [get_bd_pins ps8_axi_periph/M00_ACLK] [get_bd_pins zynq_ultra_ps_e/maxihpm1_fpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_pl_resetn0 [get_bd_pins zynq_ultra_ps_e/pl_resetn0] [get_bd_pins radio/ext_reset_in] [get_bd_pins proc_sys_reset_100M/ext_reset_in] [get_bd_pins proc_sys_reset_307_2M/ext_reset_in]

  # Create address segments
  assign_bd_address -offset 0xA0090000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/transmitter/channel_22/control/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA0080000 -range 0x00010000 -with_name SEG_control_reg0_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/transmitter/channel_20/control/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA00A0000 -range 0x00010000 -with_name SEG_control_reg0_2 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/transmitter/channel_30/control/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA00B0000 -range 0x00010000 -with_name SEG_control_reg0_3 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/transmitter/channel_32/control/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA0040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_10/decimator/xsg_bwselector_s_axi/reg0] -force
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -with_name SEG_decimator_reg0_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_12/decimator/xsg_bwselector_s_axi/reg0] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -with_name SEG_decimator_reg0_2 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_00/decimator/xsg_bwselector_s_axi/reg0] -force
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -with_name SEG_decimator_reg0_3 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_02/decimator/xsg_bwselector_s_axi/reg0] -force
  ...
  assign_bd_address -offset 0xA0050000 -range 0x00010000 -with_name SEG_spectrum_analyser_reg0_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_10/spectrum_analyser/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA0070000 -range 0x00010000 -with_name SEG_spectrum_analyser_reg0_2 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_12/spectrum_analyser/AXI4_Lite/reg0] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -with_name SEG_spectrum_analyser_reg0_3 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs radio/receiver/channel_00/spectrum_analyser/AXI4_Lite/reg0] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces radio/receiver/channel_12/spectrum_analyser/AXI4_Master] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces radio/receiver/channel_12/spectrum_analyser/AXI4_Master] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_LPS_OCM] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces radio/receiver/channel_00/spectrum_analyser/AXI4_Master] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_HIGH]
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces radio/receiver/channel_02/spectrum_analyser/AXI4_Master] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_HIGH]
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces radio/receiver/channel_10/spectrum_analyser/AXI4_Master] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_HIGH]
  exclude_bd_addr_seg -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces radio/receiver/channel_12/spectrum_analyser/AXI4_Master] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP4/HP2_DDR_HIGH]
